...
public class TestDataInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Post post2 = postRepository.save(new Post("글쓴이2", "제목2", "내용3", user2));
        commentRepository.save(new Comment("1234", "123", user1, post1));
        commentRepository.save(new Comment("1234", "123", user1, post2));
    }
}